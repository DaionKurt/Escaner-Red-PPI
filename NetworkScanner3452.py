...
class Ui_principal(object):
    def setupUi(self, principal):
        ...
        self.tabs_2 = QtWidgets.QTabWidget(self.centralwidget)
        ...
        self.tabs_2.addTab(self.tab_escaneo, "")
        ...
        self.tabs_2.addTab(self.tab_servicios, "")



        self.tab_ftp = QtWidgets.QWidget()
        self.tab_ftp.setObjectName("tab_ftp")
        self.verticalLayout_17 = QtWidgets.QVBoxLayout(self.tab_ftp)
        self.verticalLayout_17.setObjectName("verticalLayout_17")
        self.verticalLayout_16 = QtWidgets.QVBoxLayout()
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.titulo_ftp = QtWidgets.QLabel(self.tab_ftp)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.titulo_ftp.setFont(font)
        self.titulo_ftp.setObjectName("titulo_ftp")
        self.verticalLayout_16.addWidget(self.titulo_ftp)
        self.lista_ftp = QtWidgets.QListWidget(self.tab_ftp)
        self.lista_ftp.setObjectName("lista_ftp")
        self.verticalLayout_16.addWidget(self.lista_ftp)
        self.horizontalLayout_17 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_17.setObjectName("horizontalLayout_17")
        self.verticalLayout_15 = QtWidgets.QVBoxLayout()
        self.verticalLayout_15.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.label_6 = QtWidgets.QLabel(self.tab_ftp)
        self.label_6.setMaximumSize(QtCore.QSize(300, 16777215))
        self.label_6.setObjectName("label_6")
        self.verticalLayout_15.addWidget(self.label_6)
        self.boton_descargar = QtWidgets.QPushButton(self.tab_ftp)
        self.boton_descargar.setMaximumSize(QtCore.QSize(150, 16777215))
        self.boton_descargar.setObjectName("boton_descargar")
        self.verticalLayout_15.addWidget(self.boton_descargar)
        self.horizontalLayout_17.addLayout(self.verticalLayout_15)
        self.horizontalLayout_16 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_16.setObjectName("horizontalLayout_16")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout()
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.label_3 = QtWidgets.QLabel(self.tab_ftp)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_14.addWidget(self.label_3)
        self.label_arc_selecci = QtWidgets.QLabel(self.tab_ftp)
        self.label_arc_selecci.setMinimumSize(QtCore.QSize(315, 0))
        self.label_arc_selecci.setObjectName("label_arc_selecci")
        self.verticalLayout_14.addWidget(self.label_arc_selecci)
        self.horizontalLayout_16.addLayout(self.verticalLayout_14)
        self.verticalLayout_5 = QtWidgets.QVBoxLayout()
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.boton_sel_archivo = QtWidgets.QPushButton(self.tab_ftp)
        self.boton_sel_archivo.setObjectName("boton_sel_archivo")
        self.verticalLayout_5.addWidget(self.boton_sel_archivo)
        self.boton_subir_archivo = QtWidgets.QPushButton(self.tab_ftp)
        self.boton_subir_archivo.setObjectName("boton_subir_archivo")
        self.verticalLayout_5.addWidget(self.boton_subir_archivo)
        ...
        self.tabs_2.addTab(self.tab_ftp, "")
        ...
        self.spinner_min_puerto.setMaximum(1000)
        ...
        self.spinner_max_puerto.setMaximum(1000)
        ...
        self.tabs_2.addTab(self.tab_config, "")
        self.verticalLayout_6.addWidget(self.tabs_2)
    ...
    def retranslateUi(self, principal):
        ...
        self.tabs_2.setTabText(self.tabs_2.indexOf(self.tab_escaneo), _translate("principal", "Escaneo de red"))
        ...
        self.tabs_2.setTabText(self.tabs_2.indexOf(self.tab_servicios), _translate("principal", "Inicio de servicios"))
        self.titulo_ftp.setText(_translate("principal", "Acciones sobre el servidor FTP"))
        self.label_6.setText(_translate("principal", "Archivo seleccionado del servidor:"))
        self.boton_descargar.setText(_translate("principal", "Descargar"))
        self.label_3.setText(_translate("principal", "Archivo a subir actual:"))
        self.label_arc_selecci.setText(_translate("principal", "No hay archivo seleccionado"))
        self.boton_sel_archivo.setText(_translate("principal", "Seleccionar archivo"))
        self.boton_subir_archivo.setText(_translate("principal", "Subir archivo"))
        self.tabs_2.setTabText(self.tabs_2.indexOf(self.tab_ftp), _translate("principal", "Subir/bajar archivos FTP"))
        ...
        self.tabs_2.setTabText(self.tabs_2.indexOf(self.tab_config), _translate("principal", "Configuraciones"))
